...
register_setting(
    ...
    description="Dotted package path and class name of the function "
        ...
        "function ``mezzanine.shop.utils.set_shipping``.",
    editable=False,
    default="mezzanine.shop.checkout.default_billship_handler",
)
...
register_setting(
    ...
    description="Dotted package path and class name of the function "
        ...
        "function ``mezzanine.shop.utils.set_tax``.",
    editable=False,
    default="mezzanine.shop.checkout.default_tax_handler",
)
...
register_setting(
    ...
    editable=False,
    default="mezzanine.shop.checkout.default_order_handler",
)
...
register_setting(
    ...
    editable=False,
    default="mezzanine.shop.checkout.default_payment_handler",
)
