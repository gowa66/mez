...
from mezzanine.shop.models import Product, ProductOption, ProductVariation
from mezzanine.shop.models import ProductImage
from mezzanine.shop.models import Category, Cart, Order, DiscountCode
from mezzanine.shop.models import Sale
from mezzanine.shop.forms import OrderForm
from mezzanine.shop.checkout import CHECKOUT_STEPS
from mezzanine.shop.utils import set_tax
...
try:
    ...
    stripe_handler = "mezzanine.shop.payment.stripe_api.process"
    stripe_used = settings.SHOP_HANDLER_PAYMENT == stripe_handler
    if stripe_used:
        settings.STRIPE_API_KEY = "dummy"
        from mezzanine.shop.payment import stripe_api
